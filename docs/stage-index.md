...
- [SecondaryMarketAnalyst Stage Prompts](stage-prompts-secondary-market-analyst.md)：10 个业务 Stage 的可优化 prompt templates，包含变量占位符、输出字段和优化记录模板。
