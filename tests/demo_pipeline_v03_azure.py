#!/usr/bin/env python3
"""Run Pipeline v0.3 with real Azure OpenAI calls authenticated by `az login`.
...
from tsgo.azure_openai_client import AzureOpenAIResponsesModelClient  # noqa: E402
from tsgo.runtime import DEFAULT_V03_QUERY, run_llm_pipeline_message  # noqa: E402


def main() -> None:
    parser = argparse.ArgumentParser(description="Run Pipeline v0.3 with Azure OpenAI via az login.")
    parser.add_argument("message", nargs="?", default=DEFAULT_V03_QUERY)
    parser.add_argument("--trace-path", default="traces/pipeline_v03_azure_traces.jsonl")
        ...
        json.dumps(
            {
                ...
                "azure_model_call_count": len(client.prompts),
